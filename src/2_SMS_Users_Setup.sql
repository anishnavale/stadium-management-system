...
begin
    ...
    execute immediate 'create user '|| currentUser ||' identified by "Sms@SM@123456789" default tablespace DATA quota 10m on DATA';
    ...
    dbms_output.put_line('Trying to create user: '|| currentUser);
    execute immediate 'create user '|| currentUser ||' identified by "Sms@FM@123456789" default tablespace DATA quota 10m on DATA';
    execute immediate 'grant CONNECT to '|| currentUser;    
    dbms_output.put_line('Created user: '|| currentUser);
    dbms_output.put_line('Granted CONNECT to user: '|| currentUser);
    ...
    dbms_output.put_line('Trying to create user: '|| currentUser);
    execute immediate 'create user '|| currentUser ||' identified by "Sms@CUST@123456789" default tablespace DATA quota 10m on DATA';
    execute immediate 'grant CONNECT to '|| currentUser;    
    dbms_output.put_line('Created user: '|| currentUser);
    dbms_output.put_line('Granted CONNECT to user: '|| currentUser);
    ...
    dbms_output.put_line('Trying to create user: '|| currentUser);
    execute immediate 'create user '|| currentUser ||' identified by "Sms@SS@123456789" default tablespace DATA quota 10m on DATA';
    execute immediate 'grant CONNECT to '|| currentUser;    
    dbms_output.put_line('Created user: '|| currentUser);
    dbms_output.put_line('Granted CONNECT to user: '|| currentUser);
