...
begin
    ...
    seqName:='SEQ_VER_VERIFICATION_ID';
    select count(1) into seqCount from all_sequences where sequence_name=seqName and sequence_owner='APP_ADMIN';
