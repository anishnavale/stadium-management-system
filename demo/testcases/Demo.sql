...
exec APP_ADMIN.PACK_STADIUM_MANAGEMENT.PROC_UPDATE_SECTION(2, 'G1', '563 Park Drive', 'Boston', 'MA', '02215');
...
exec APP_ADMIN.PACK_STADIUM_MANAGEMENT.PROC_ADD_NEW_SECTION_CATEGORY(2,3);

--Add section category North, VIP
exec APP_ADMIN.PACK_STADIUM_MANAGEMENT.PROC_ADD_NEW_SECTION_CATEGORY(2,4);
...
exec APP_ADMIN.PACK_STADIUM_MANAGEMENT.PROC_ADD_NEW_SEATS(3,'A', 5);

--Add 5 seats to North General B row
exec APP_ADMIN.PACK_STADIUM_MANAGEMENT.PROC_ADD_NEW_SEATS(3,'B', 5);

--Add 5 seats to North VIP C row
exec APP_ADMIN.PACK_STADIUM_MANAGEMENT.PROC_ADD_NEW_SEATS(4,'C', 5);

--Add 5 seats to North VIP D row
exec APP_ADMIN.PACK_STADIUM_MANAGEMENT.PROC_ADD_NEW_SEATS(4,'D', 5);
...
exec APP_ADMIN.PACK_STADIUM_MANAGEMENT.PROC_ADD_NEW_SEATS(4, 'D', 10);
...
exec APP_ADMIN.PACK_MATCH_MANAGEMENT.PROC_MODIFY_MATCH(5, NULL,'MUMBAI', 'CHENNAI', TO_DATE('11-DEC-2022 10:00:00 AM', 'DD-MON-YYYY HH:MI:SS AM'), TO_DATE('11-DEC-2022 02:00:00 PM', 'DD-MON-YYYY HH:MI:SS AM'), 'Y');

--Updating the match to change status flag=Inactive (Check the id in match table first)
exec APP_ADMIN.PACK_MATCH_MANAGEMENT.PROC_MODIFY_MATCH(5, 'IPL','MUMBAI', 'CHENNAI', TO_DATE('11-DEC-2022 10:00:00 AM', 'DD-MON-YYYY HH:MI:SS AM'), TO_DATE('11-DEC-2022 02:00:00 PM', 'DD-MON-YYYY HH:MI:SS AM'), 'N');

--Updating match with same team names(Check the id in match table first)
exec APP_ADMIN.PACK_MATCH_MANAGEMENT.PROC_MODIFY_MATCH(5, 'IPL','MUMBAI', 'MUMBAI', TO_DATE('12-DEC-2022 10:00:00 AM', 'DD-MON-YYYY HH:MI:SS AM'), TO_DATE('12-DEC-2022 11:00:00 AM', 'DD-MON-YYYY HH:MI:SS AM'), 'Y');

--Updating match with less than 2 hour duration(Check the id in match table first)
exec APP_ADMIN.PACK_MATCH_MANAGEMENT.PROC_MODIFY_MATCH(5, 'IPL','MUMBAI', 'CHENNAI', TO_DATE('12-DEC-2022 10:00:00 AM', 'DD-MON-YYYY HH:MI:SS AM'), TO_DATE('12-DEC-2022 11:00:00 AM', 'DD-MON-YYYY HH:MI:SS AM'), 'Y');

--Reactivating the match(Check the id in match table first)
exec APP_ADMIN.PACK_MATCH_MANAGEMENT.PROC_MODIFY_MATCH(5, 'IPL','MUMBAI', 'CHENNAI', TO_DATE('11-DEC-2022 10:00:00 AM', 'DD-MON-YYYY HH:MI:SS AM'), TO_DATE('11-DEC-2022 02:00:00 PM', 'DD-MON-YYYY HH:MI:SS AM'), 'Y');
...
exec APP_ADMIN.PACK_PRICING_MANAGEMENT.proc_add_in_price_catlog(5, 1, 10);

--Add North VIP Price for Match 1 as $20 (Check the id in match table first)
exec APP_ADMIN.PACK_PRICING_MANAGEMENT.proc_add_in_price_catlog(5, 2, 20);
...
exec APP_ADMIN.PACK_PRICING_MANAGEMENT.proc_add_in_price_catlog(5, 2, -190);
...
exec APP_ADMIN.PACK_PRICING_MANAGEMENT.proc_add_in_price_catlog(5, 1000, 10);
...
exec APP_ADMIN.PACK_TICKET_MANAGEMENT.PROC_BOOK_TICKET(NULL, 5, APP_ADMIN.seatIDList(1,2,3,4,5), 'Christmas', 'Online');

--Customer not exists
exec APP_ADMIN.PACK_TICKET_MANAGEMENT.PROC_BOOK_TICKET(100, 5, APP_ADMIN.seatIDList(1,2,3,4,5), 'Christmas', 'Online');

--Match not exists
exec APP_ADMIN.PACK_TICKET_MANAGEMENT.PROC_BOOK_TICKET(1, 100, APP_ADMIN.seatIDList(1,2,3,4,5), 'Christmas', 'Online');

--Seats not existing
exec APP_ADMIN.PACK_TICKET_MANAGEMENT.PROC_BOOK_TICKET(1, 5, APP_ADMIN.seatIDList(1000, 2000), 'Christmas', 'Online');

--Discount not provided
exec APP_ADMIN.PACK_TICKET_MANAGEMENT.PROC_BOOK_TICKET(1, 5, APP_ADMIN.seatIDList(1,2), NULL, 'Online');

--Booking the already booked seats
exec APP_ADMIN.PACK_TICKET_MANAGEMENT.PROC_BOOK_TICKET(1, 5, APP_ADMIN.seatIDList(1,2), NULL, 'Online');

--Discount coupon invalid
exec APP_ADMIN.PACK_TICKET_MANAGEMENT.PROC_BOOK_TICKET(2, 5, APP_ADMIN.seatIDList(3,4), 'MyCoupon', 'Online');

--Discount coupon valid
exec APP_ADMIN.PACK_TICKET_MANAGEMENT.PROC_BOOK_TICKET(3, 5, APP_ADMIN.seatIDList(5,6), 'Christmas', 'Online');
